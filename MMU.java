...
public class MMU extends IflMMU {
   ...
   // PageFaultHandler.init();
    ...
    static public PageTableEntry do_refer(int memoryAddress,
        ...
        int realPageAddress = memoryAddress / pageSize;
        PageTableEntry page = MMU.getPTBR().pages[realPageAddress];

        if (page.isValid()) //if memory address is valid
        {
            //update attributes
            ...
            //its already called the pageFaultHandler
            if (page.getValidatingThread() != null) {
                ...
                //it hasn't called the pageFaultHandler, so call it
            } else {
